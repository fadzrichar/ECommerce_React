        ...
        <div id="formContent">
          ...
          <form onSubmit={e => e.preventDefault()}>
            ...
            <input
              ...
              onChange={e => this.props.changeInput(e)}
            />
            <input type="submit" className="fadeIn fourth" value="Log In" onClick={this.handleLogin} />
            <p>Didnt have an Account?</p>
            <Link to="/registration" class="nav-link pt-0 m-0" style={{ color: '#145374' }}>
              Register here
            </Link>
          </form>
