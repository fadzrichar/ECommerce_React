...
class ProductDetail extends Component {
  componentDidMount = () => {
    ...
    store.setState({ idProduct: produk_id });
    // console.log("cek state id", this.props.idProduct)
...
export default connect("product_detail, idProduct, quantity", actions)(withRouter(ProductDetail));