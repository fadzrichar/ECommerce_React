...
class Registration extends Component {
    ...
    doReg = async () => {
        ...
        console.warn('cek string', this.props.isLogin)
...
export default connect("isLogin, username, fullname, email, password, address, phone, image", actions)(withRouter(Registration));